...
func (this *Chain) addBlockToChain(newBlock *Block, key *functions.GKey) {
...
func (this *Chain) MineTransactionPool(minerAddress string, key *functions.GKey) {
	//发放矿工奖励
...
func (this *Chain) validataChain(key *functions.GKey) bool {
	if 1 == len(this.chain) {
...
func (this *Chain) AddTransaction(transaction Transaction, key *functions.GKey) {
